function App() {
  ...
  return (
    <>
      <main>
        <article>
          ...
          <p>
            ...
            <a href="http://www.colouringcode.com">colourer of code</a>.
          </p>
          <p>
            Plays bass, <a href="http://www.sitwell.cc">rides bikes</a>, enjoys craft beer,
            bourbons and ryes.{' '}
      ...
      <footer>
        <p>
          &copy; 1985-{date}. A <a href="http://www.colouringcode.com">Colouring Code</a> design

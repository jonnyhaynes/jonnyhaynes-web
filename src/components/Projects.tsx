...
export function Projects() {
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      // Where the section does not stick, the scroller is its own natural height and the
      // track is an ordinary swipeable one. The height has to be *removed*, not left alone:
      // it is inline, so the stylesheet cannot take it back.
      if (!pinned) {
